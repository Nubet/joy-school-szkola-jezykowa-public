    ...
    <section className="py-24 bg-white border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 px-2 sm:px-0">
          <div className="relative aspect-square md:aspect-4/5 rounded-3xl sm:rounded-[2rem] overflow-hidden shadow-soft">
            <Image 
          ...
          <div className="relative aspect-square md:aspect-4/5 rounded-3xl sm:rounded-[2rem] overflow-hidden shadow-soft md:mt-12">
            <Image 
